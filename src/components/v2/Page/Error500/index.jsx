...
export default function ErrorPage() {
  return (
    <div className={styles["main-error-page"]}>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g>
            ...
            <path
              ...
              transform="translate(-448 -158) translate(448 157)"
            />
            <g className={styles["full-torradeira"]}>
      ...
      <h2 className={styles["error-subtitle"]}>
